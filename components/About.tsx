  ...
  return (
    <section id="about" className="py-16 md:py-40 relative overflow-hidden">
      <div className="container mx-auto px-6 lg:px-12 relative z-10 max-w-7xl">
        ...
        {/* Vision Statement */}
        <div className="text-black mb-20 md:mb-32 flex flex-col justify-center items-center">
          <div className="max-w-full flex flex-col items-center gap-4 md:gap-6">
            ...
            <p className="text-3xl md:text-6xl lg:text-7xl font-paperlogy font-bold leading-tight tracking-tight break-keep text-black mt-4 text-center">
              저희는 컨텐츠 집행만 하지 않습니다 <br />
              고객님의 <span className="underline decoration-[#2454ff] underline-offset-4 md:underline-offset-8">전환</span>까지 책임지고 함께합니다
            </p>
          </div>
        </div>
        {/* Header */}
        <div className="mb-12 md:mb-20 flex flex-col md:flex-row justify-between items-start md:items-end gap-6 md:gap-12">
          <div className="max-w-3xl">
            <h4 className="text-gray-500 font-semibold tracking-widest uppercase mb-4 md:mb-6 text-xs md:text-sm">About Platform</h4>
          ...
          <div className="mt-4 md:mt-0 max-w-md">
            <p className="text-base md:text-lg text-gray-600 leading-relaxed font-light break-keep">
        ...
        {/* Xiaohongshu Stats */}
        <div className="bg-black text-white rounded-[2rem] md:rounded-[3rem] p-8 md:p-16 mb-16 md:mb-24 relative overflow-hidden shadow-2xl border border-black/5">
